...
| `test_normalize.c` | body trim/size, UTF-8 edge rejections (overlong/surrogate/range/truncation), NUL-terminates, tag/key normalize, accurate error codes, SHA-256 NIST vectors (step 03 pure unit; harness + ASan/UBSan unit binary, digest instrumented) |
