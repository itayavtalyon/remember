...
| 005 | [sync-foundations](005-sync-foundations.md) | `sync_id` (UUID v7), soft-delete + bins, device sidecar + VV, import merge + conflicts, `--sync-id` locators | Design (finalized, 2026-09-20) |
